...
public class AssignmentNotesRenderer extends RendererBase {
    ...
    private final String title = "Cell Notes Assignment";
    ...
    public AssignmentNotesRenderer(ValueCell cell, Notes combinationNotes, Notes oldNotes) {
